...
# Salva em Dataset o conjunto de dados selecionados
Dataset = st.sidebar.selectbox('Dataset',('Iris', 'Wine', 'Breast Cancer'))
# Salva em Split o padrão de divisão da base para treino e teste, deixando como default 70-30
...
# Os nomes dos algoritmos devem estar exatamente como na documentação do SkLearn
Solver = st.sidebar.selectbox('Algoritmo', ('lbfgs', 'newton-cg', 'liblinear', 'sag'))
# Opções do tipo box para as estratégias de regularização
...
#FIXME talvez seja necessário um validador de string para os inputs de texto (valores extremos etc)
...
if(st.sidebar.button("Clique Para Treinar o Modelo de Regressão Logística")):
    ...
    # Obrigado
    st.write("Obrigado por usar esta app do Streamlitermans!")
